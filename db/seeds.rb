...
question_list = [
  ["You find it easy to introduce yourself to other people", 1, 0],
  ["You often get so lost in thoughts that you ignore or forget your surroundings.", 0, 1],
  ["You fin it easy to stay relaxed and focused even when there is some pressure.", 0, 1],
  ["You don't usually initiate conversations", 1, 0],
  ["You feel a constant need for something new", 1, 0],
  ["You have numerous and varied interests rather than several specific ones", 1, 0],
  ["Being adaptable is more important to you than being organised", 0, -1],
  ["Solving practical problems interests you more than finding answers to existential questions", 0, 1],
